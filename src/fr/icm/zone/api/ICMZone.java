...
public class ICMZone {
    ...
    public boolean isCanInteractAtEntity() {
        return canInteractAtEntity;
    }

    public void setCanInteractAtEntity(boolean canInteractAtEntity) {
        this.canInteractAtEntity = canInteractAtEntity;
    }
    ...
    public void setFoodLess(boolean foodLess) {
        this.foodLess = foodLess;
    }
    ...
    public boolean isCanEntityDamage() {
        return canEntityDamage;
    }

    public void setCanEntityDamage(boolean canEntityDamage) {
        this.canEntityDamage = canEntityDamage;
    }
    ...
    public void setCanMobSpawn(boolean canMobSpawn) {
        this.canMobSpawn = canMobSpawn;
    }

    public boolean isCanViewOtherPlayer() {
        return canViewOtherPlayer;
    }

    public void setCanViewOtherPlayer(boolean canViewOtherPlayer) {
        this.canViewOtherPlayer = canViewOtherPlayer;
    }

    public void save()
    {
        PvPBox.getZoneStorage.write(this);
    }

    public void delete()
    {
        PvPBox.getZoneStorage.remove(this);
    }
