...
public class DuelBox {
    ...
    public void summon()
    {
        ...
        if(getNortWall(radius) == null)
            return;
        if(getWesttWall(radius) == null)
            return;
        if(getSouthWall(radius) == null)
            return;
        if(getEastWall(radius) == null)
            return;
    ...
    private void placeArena(Material material, ArrayList<Location> platform, ArrayList<Location> southWall, ArrayList<Location> westtWall, ArrayList<Location> nortWall, ArrayList<Location> eastWall)
    {
        ...
        new BukkitRunnable() {
            @Override
            public void run() {
                if (platform.isEmpty() && southWall.isEmpty() && westtWall.isEmpty() && nortWall.isEmpty() && eastWall.isEmpty()) {
                ...
                if (ownerLocTP.getX() != owners.getLocation().getX() || ownerLocTP.getZ() != owners.getLocation().getZ() || ownerLocTP.getY() != owners.getLocation().getY())
                ...
                if(otherLocTP.getX() != others.getLocation().getX() || otherLocTP.getZ() != others.getLocation().getZ() || otherLocTP.getY() != others.getLocation().getY())
    ...
    public void setLastOther(Location lastOther) { this.lastOther = lastOther; }
    public void setLastOwner(Location lastOwner) { this.lastOwner = lastOwner; }
