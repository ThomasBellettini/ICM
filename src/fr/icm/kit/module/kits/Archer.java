...
public class Archer extends Kit {
    ...
    public Archer() {
        super("archer", 2, false, false);

        setSecret(true);

        Presentation p = new Presentation("§6» Kit Archer", Arrays.asList(" "
    ...
    private ArrayList<ItemStack> tierOne() {
        ...
        legsMeta.setColor(Color.fromRGB(150,150,150));
        helmetMeta.setColor(Color.fromRGB(150,150,150));
